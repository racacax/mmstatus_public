...
def forward(old_orm, new_orm):
    season = new_orm['season']
    return [
        # Apply default value False to the field season.is_aggregated,
        season.update({season.is_aggregated: False}).where(season.is_aggregated.is_null(True)),
    ]
