...
def forward(old_orm, new_orm):
    playergame = new_orm['playergame']
    return [
        # Apply default value False to the field playergame.is_mvp,
        playergame.update({playergame.is_mvp: False}).where(playergame.is_mvp.is_null(True)),
        # Apply default value False to the field playergame.is_win,
        playergame.update({playergame.is_win: False}).where(playergame.is_win.is_null(True)),
    ]
